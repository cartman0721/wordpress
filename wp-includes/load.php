...
function wp_unregister_GLOBALS() {
	...
	if ( isset( $_REQUEST['GLOBALS'] ) )
		die( /*WP_I18N_GLOBALS_OVERWRITE*/'检测到试图覆盖 GLOBALS 变量'/*/WP_I18N_GLOBALS_OVERWRITE*/ );
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) )
		die( sprintf( /*WP_I18N_OLD_PHP*/'您服务器使用的 PHP 版本为 %1$s，但是 WordPress %2$s 需要至少 %3$s。'/*/WP_I18N_OLD_PHP*/, $php_version, $wp_version, $required_php_version ) );

	if ( !extension_loaded( 'mysql' ) && !file_exists( WP_CONTENT_DIR . '/db.php' ) )
		die( /*WP_I18N_OLD_MYSQL*/'WordPress 需要 PHP 具有 MySQL 扩展，但是您的服务器没有安装。'/*/WP_I18N_OLD_MYSQL*/ );
}
...
?>
	...
	<body>
		<h1><?php echo /*WP_I18N_MAINT_MSG*/'例行维护中，请稍后再访问。'/*/WP_I18N_MAINT_MSG*/; ?></h1>
	</body>
	</html>
<?php
	die();
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>错误</strong>: <code>wp-config.php</code> 中的 <code>$table_prefix</code> 只能由数字、字母和下划线构成。'/*/WP_I18N_BAD_PREFIX*/ );
}
